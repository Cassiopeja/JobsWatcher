...
{
    public partial class Initalizations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_SourceTypes_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SourceAreas", x => x.Id);
                    table.UniqueConstraint("AK_SourceAreas_SourceId_SourceTypeId", x => new { x.SourceId, x.SourceTypeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SourceEmployers", x => x.Id);
                    table.UniqueConstraint("AK_SourceEmployers_SourceId_SourceTypeId", x => new { x.SourceId, x.SourceTypeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSalaryGross = table.Column<bool>(type: "boolean", nullable: true),
                    Url = table.Column<string>(type: "text", nullable: true),
                    RawData = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdateDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ContentUpdateDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
